...
local Load = function()
		...
		Menu.Items.BC.LS:MenuElement({name = "Max HP(%)",  id = "MyHP", value = 700, min = 1, max = 100, step = 1})
        Menu.Items.BC.LS:MenuElement({name = "Enemy Max HP(%)",  id = "EnemyHP", value = 70, min = 1, max = 100, step = 1})
		Menu.Items.BC:MenuElement({name = "Use to KS",  id = "KS", value = true})
		...
		Menu.Items.BOTRK:MenuElement({name = "Use to KS",  id = "KS", value = true})
        Menu.Items:MenuElement({type = MENU, name = "YG's Ghostblade",  id = "YG"})
		...
		Menu.Items.RO.LS:MenuElement({name = "Max HP(%)",  id = "MyHP", value = 700, min = 1, max = 100, step = 1})
		...
		Menu.Items.HG.LS:MenuElement({name = "Max HP(%)",  id = "MyHP", value = 700, min = 1, max = 100, step = 1})
		...
		Menu.Items.HPB.LS:MenuElement({name = "Max HP(%)",  id = "MyHP", value = 700, min = 1, max = 100, step = 1})
		...
		Menu.Items.GLP.LS:MenuElement({name = "Max HP(%)",  id = "MyHP", value = 700, min = 1, max = 100, step = 1})
